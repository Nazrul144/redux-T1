...
export const quizData: QuizItem[] = [
  {
    ...
    options: ["কুমিল্লার এক কিশোরের মুখে", "শেখ হাসিনার বক্তিতায়", "জাহাঙ্গীরনগর বিশ্ববিদ্যালয়ে", "কক্সবাজারে"],
    correctAnswer: "কুমিল্লার এক কিশোরের মুখে",
  },
  {
    id: 2,
    question: "‘চালাইদেন’ এই সংলাপটি কী কারণে ভাইরাল হয়েছিল?",
    options: ["পলকের মজার পোস্টে", "রাজনৈতিক বক্তিতায়", "আনসার আন্দোলনের সময়", "কোটা আন্দোলনে"],
    correctAnswer: "কোটা আন্দোলনে",
  },
  {
    id: 3,
    question: "'নাইস অ্যান্ড অ্যাট্রাকটিভ' এই জনপ্রিয় মন্তব্যটি কোন ঘটনার পর ভাইরাল হয়েছিল?",
    options: [
  ...
  {
    id: 5,
    question: "‘এই ওয়েট ওয়েট, ইটস মাই টার্ন’ এই সংলাপটি কী কারণে ভাইরাল হয়েছিল?",
    options: [
  ...
  },
  {
    ...
    options: ["শেখ হাসিনা", "মাওলানা মোস্তাক ফয়েজী", "বিচারপতি শামসুদ্দিন চৌধুরী মানিক", "ওবায়দুল কাদের"],
    correctAnswer: "বিচারপতি শামসুদ্দিন চৌধুরী মানিক",
  },
  {
    id: 7,
    question: "‘শেখ হাসিনা পালায় না’ এই বিখ্যাত সংলাপটি কোথায় শোনা গিয়েছিল?",
    options: ["আন্তর্জাতিক আদালতের মামলার সময়ে", "নির্বাচনী প্রচারণায়", "গণঅভ্যুত্থানের সময়", "ওবায়দুল কাদেরের বক্তিতায়"],
  ...
  {
    id: 10,
    question: "‘আবেগ কাজ করেছে, বিবেক কাজ করেনি’ এই বিতর্কিত মন্তব্যটি কোন ঘটনার পর ব্যাপকভাবে আলোচিত হয়েছিল?",
    options: [
